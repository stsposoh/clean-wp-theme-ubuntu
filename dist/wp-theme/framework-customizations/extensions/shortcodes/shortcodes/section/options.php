...
$options = array(
    ...
    'further_info'              => array(
        'label' => __( 'Further attributes', 'the-core' ),
        'desc'  => __( 'For example data- attributes. Point without quotes', 'the-core' ),
        'help'  => __( 'For example: data-parallax=scroll', 'the-core' ),
        'type'  => 'text',
        'value' => '',
    ),
);
