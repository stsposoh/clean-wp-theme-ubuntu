...
$options = array(
	...
	'header_slider' => array(
		'type'          => 'addable-popup',
		'label'         => __( 'Slider for Header', 'fw' ),
		'popup-title'   => __( 'Add/Edit slide', 'fw' ),
		'desc'          => __( 'Show popup with slides', 'fw' ),
		'template'      => '{{- header_slider_title }}',
		'popup-options' => array(
			'header_slider_title' => array(
				'label' => __( 'Header slide title', 'unyson' ),
				'type'  => 'text',
				'value' => ''
			),
			'header_slider_sub_title' => array(
				'label' => __( 'Header slide sub-title', 'unyson' ),
				'type'  => 'text',
				'value' => ''
			),
			'header_slider_text' => array(
				'label' => __( 'Header slide text', 'unyson' ),
				'type'  => 'wp-editor',
				'value' => ''
			),
			'header_slider_poster' => array(
				'type'  => 'upload',
				'label' => __('Header slide video poster', 'unyson'),
				'images_only' => true
			),
			'header_slider_video' => array(
				'type'  => 'upload',
				'label' => __('Header slide video', 'unyson'),
				'images_only' => false,
				'files_ext' => array( 'mp4' ),
			),
			'header_slider_link' => array(
				'label' => __( 'Header slide button link', 'unyson' ),
				'type'  => 'text',
				'value' => '#'
			),
		),
	),
  'header_link_news' => array(
    'label' => __( 'Header link to News', 'unyson' ),
    'type'  => 'text',
    'value' => '#'
  ),
  'header_link_market' => array(
    'label' => __( 'Header link to Market', 'unyson' ),
    'type'  => 'text',
    'value' => '#'
  ),
  'header_link_shows' => array(
    'label' => __( 'Header link to Shows', 'unyson' ),
    'type'  => 'text',
    'value' => '#'
  ),
	...
	/*
    'demo_video_bg'                    => array(
        'label'       => __( 'Фоновая картинка для шапки с видео', 'unyson' ),
        'type'        => 'upload',
        'images_only' => true,
    ),
    'demo_video_logo'                    => array(
        'label'       => __( 'Логотип для шапки с видео', 'unyson' ),
        'type'        => 'upload',
        'images_only' => true,
    ),
    'demo_phone'                      => array(
    ...
    'demo_mail'                      => array(
        'label' => __( 'Почта', 'unyson' ),
        'type'  => 'text',
        'value' => ''
    ),
	'demo_presentation'                      => array(
		'label' => __( 'Ссылка на презентацию', 'unyson' ),
        'desc'        => __( '', 'unyson' ),
        'type'        => 'upload',
        'images_only' => false,
	),
    'social_fb'                      => array(
        'label' => __( 'ссылка на FaceBook', 'unyson' ),
        'type'  => 'text',
        'value' => ''
    ),
    'social_inst'                      => array(
        'label' => __( 'ссылка на Instagram', 'unyson' ),
        'type'  => 'text',
        'value' => ''
    ),
    'social_tw'                      => array(
        'label' => __( 'ссылка на Twitter', 'unyson' ),
        'type'  => 'text',
        'value' => ''
    ),
    'social_vk'                      => array(
        'label' => __( 'ссылка на VK', 'unyson' ),
        'type'  => 'text',
        'value' => ''
    ),
    'partnership'                      => array(
        'label' => __( 'ссылка на партнеров', 'unyson' ),
        'type'  => 'text',
        'value' => ''
    ),

	'demo_text_button'                      => array(
		'label' => __( 'Text in button', 'unyson' ),
		'type'  => 'text',
		'value' => ''
	),
	'demo_textarea'                  => array(
